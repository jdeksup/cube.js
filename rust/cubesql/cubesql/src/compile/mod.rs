    ...
    */
    ...
    async fn test_pg_datetime_precision_postgres() -> Result<(), CubeError> {
        insta::assert_snapshot!(
            ...
            execute_query(
                "SELECT information_schema._pg_datetime_precision(1082, 1);".to_string(),
                DatabaseProtocol::PostgreSQL
            )
            .await?
        );
        ...
        insta::assert_snapshot!(
            "pg_datetime_precision_typmod",
            execute_query(
                "SELECT information_schema._pg_datetime_precision(1184, 3);".to_string(),
                DatabaseProtocol::PostgreSQL
            )
            .await?
        );
    ...
    async fn test_pg_numeric_scale_postgres() -> Result<(), CubeError> {
        insta::assert_snapshot!(
            "pg_numeric_scale_int8",
            execute_query(
                "SELECT information_schema._pg_numeric_scale(20, 1);".to_string(),
                DatabaseProtocol::PostgreSQL
            )
            .await?
        );
        ...
        insta::assert_snapshot!(
            "pg_numeric_scale_none",
            execute_query(
                "SELECT information_schema._pg_numeric_scale(0, 10);".to_string(),
                DatabaseProtocol::PostgreSQL
            )
            .await?
        );
